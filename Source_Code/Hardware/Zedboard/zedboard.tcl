...
user.org:user:ov7670_decode_stream:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:ip:xlconstant:1.1\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:smartconnect:1.0\
user.org:user:stream_to_vga:1.0\
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net axi_periph_M01_AXI [get_bd_intf_pins axi_periph/M01_AXI] [get_bd_intf_pins ov7670_decode_stream_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net vdma_M_AXI_MM2S [get_bd_intf_pins smartconnect_0/S00_AXI] [get_bd_intf_pins vdma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net vdma_M_AXI_S2MM [get_bd_intf_pins smartconnect_0/S01_AXI] [get_bd_intf_pins vdma/M_AXI_S2MM]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_periph/ACLK] [get_bd_pins axi_periph/M00_ACLK] [get_bd_pins axi_periph/S00_ACLK] [get_bd_pins fifo_mm2s/s_aclk] [get_bd_pins fifo_s2mm/m_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins vdma/m_axi_mm2s_aclk] [get_bd_pins vdma/m_axi_s2mm_aclk] [get_bd_pins vdma/m_axis_mm2s_aclk] [get_bd_pins vdma/s_axi_lite_aclk] [get_bd_pins vdma/s_axis_s2mm_aclk]
  connect_bd_net -net ov7670_pclk_1 [get_bd_ports ov7670_pclk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net pclk_1 [get_bd_pins axi_periph/M01_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins fifo_s2mm/s_aclk] [get_bd_pins ov7670_decode_stream_0/pclk] [get_bd_pins ov7670_decode_stream_0/s00_axi_aclk] [get_bd_pins rst_ov7670_pclk/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports ov7670_xclk] [get_bd_pins fifo_mm2s/m_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins rst_vga_clk25/slowest_sync_clk] [get_bd_pins stream_to_vga_0/clk25]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_periph/M00_ARESETN] [get_bd_pins axi_periph/S00_ARESETN] [get_bd_pins fifo_mm2s/s_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins vdma/axi_resetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ov7670_decode_stream_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vdma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x10000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces vdma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x10000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces vdma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
